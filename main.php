...
<html>
	<head>
		...
		<link rel="shortcut icon" href="http://makoframework.com/assets/img/favicon.ico">
		<link type="text/css" rel="stylesheet" href="http://makoframework.com/assets/css/materialize.min.css"  media="screen,projection"/>
		<link type="text/css" rel="stylesheet" href="http://makoframework.com/assets/css/font-awesome.min.css"  media="screen,projection"/>
		...
		<nav id="nav" class="grey darken-3-5">
			<div class="container">
				<div class="nav-wrapper">
					<a href="http://makoframework.com/" class="brand-logo"><img src="h.png" alt="Mako"></a>
					<ul id="nav-mobile" class="right side-nav">
						<li><a href="http://makoframework.com/docs">Academics</a></li>
						<li><a href="http://api.makoframework.com">Bakar</a></li>
						<li>
