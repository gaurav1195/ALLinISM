...
<?php include("includes/new_functions.php"); ?>
 ...
 <header>
      ...
      <ul id="nav-mobile" class="side-nav fixed text-white" style="background-color:">
        ...
        <li class="bold" style=";"><a href="academics.php?genre=books" class="list-group-item <?php if($sel_genre =='books'){ echo "active" ;} ?>">E-books</a></li>
        <li class="bold"><a href="academics.php?genre=papers" class="list-group-item <?php if($sel_genre =='papers'){ echo "active" ;} ?>">PY Papers</a></li>
        <li class="bold"><a href="academics.php?genre=notes" class="list-group-item <?php if($sel_genre =='notes'){ echo "active" ;} ?>">Notes</a></li>
        <li class="bold"><a href="academics.php?genre=tuts" class="list-group-item <?php if($sel_genre =='tuts'){ echo "active" ;} ?>">Tutorials</a></li>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m9">
        ...
        <h1 class="header center-on-small-only">Academics</h1>
		<?php
			if(!isset($_GET['genre'])){
        echo '<h4 class ="light red-text text-lighten-4 center-on-small-only">Collection of all available documents, 
		pdfs,e-books , previous year question papers ,<br > BLAH BLAH.</h4>';}
			?>
			<br />
