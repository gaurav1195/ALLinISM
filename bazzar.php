...
<div class="container">
  ...
  <div class="row">
	...
	<?php 
		if(isset($_GET['cat'])){
		$product_set = get_all_products($category, $price);
								if(mysql_num_rows($product_set) == 0)
								{
									echo 'Sorry there are no items in this session currently';
								}
									...
									echo '<div class="col l6">';
										echo '<div class="card" style="height:300px;">';
											echo '<div class="card-image waves-effect waves-block waves-light">';
											  ...
											  echo '<img class="activator" height="70%" src="img/bazzar/' . $product['pic_name'] . '">';
											echo '</div>';
											echo '<div class="card-content">';
											  echo '<span class="card-title activator grey-text text-darken-4" style="font-size:20px;">' . $product['product_name'] . '<i class="mdi-action-swap-vert right"></i></i></span>';
											echo '</div>';
											echo '<div class="card-reveal">';
											  echo '<span class="card-title grey-text text-darken-4">' . $product['product_name'] . '<i class="mdi-action-swap-vert right"></i></span>';
											...
											echo '<a href="buy.php?id=' . $product['id'] . '" class="btnright">Buy</a>';
											else
				...
				echo '<div class="col s12 m12">';
				  echo '<div class="card blue-grey darken-1">';
					...
					echo '<div class="card-action">';
					  echo '<a href="#">Sell Anonymously</a>';
					  echo '<a href="#">Sell Directly</a>';
					echo '</div>';
				  echo '</div>';
				echo '</div>';
			  echo '</div>';
...
<div id="buy" class="modal ">
    <div class="modal-content">
									...
									<h4 class="red-text text-lighten-2">Buy</h4><hr /><br />
									<div class="row">
										<form class="col s12">
										  <div class="row">
