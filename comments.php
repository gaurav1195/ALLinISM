...
<?php require_once("includes/header.php") ; ?>
					...
					<?php
									...
									echo '<div class="row">';
									$topics = get_topic_by_id($que_id);
									$topic = mysql_fetch_array($topics);
									echo '<h5 class="col s12 light header">' . $topic['shout'] . '</h5>';
									echo '</div>';
									echo '<div class="row">';
										echo '<form class="col s12" action="comments.php?id=' . $topic['id'] . '"method="post" >';
										  echo '<div class="row">';
											echo '<div class="input-field col s12">';
											  echo '<textarea  name="comment" class="materialize-textarea" ></textarea>';
											  echo '<label for="textarea1">Your View: :</label>';
											echo '</div>';
										  echo '</div>';
										  echo '<div class="modal-footer">';
													echo '<button class="btn btn-default" name="submit">Comment</button>';
												echo '</div>';
									...
									echo '</form>';*/
									echo '<br /><br /><hr><br /><br />';
									echo '<h5 class="col s12 light header">Previous Comments</h5>';
									$comments = get_comments_by_id($que_id);
													...
													echo '<br /><div class="row">';
													  echo '<div class="col s12 m9 l12">';
														echo '<div class="card-panel teal">';
														  ...
														  echo '<span class="white-text"> ' . $comment['comment'];
														  echo '</span><br />';
														  echo '<br /><div style="color:white;font-size:8px">Posted On: ' . $comment['time'] . '</div>';
